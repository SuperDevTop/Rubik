...
public class CubeState : MonoBehaviour
{
    ...
    public List<GameObject> middleFront = new List<GameObject>();
    public List<GameObject> middleRight = new List<GameObject>();
    ...
    public string GetStateString()
    {
        ...
        stateString += GetSideString(middleFront);
        stateString += GetSideString(middleRight);
        return stateString;
    }
}