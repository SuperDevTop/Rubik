...
public class PivotRotation : MonoBehaviour
{
    ...
    private void SpinSide(List<GameObject> side)
    {
        ...
        GameObject faceUp = GameObject.Find("U");    
        GameObject faceDown = GameObject.Find("D");  
        GameObject faceFront = GameObject.Find("F");  
        GameObject faceBack = GameObject.Find("B");  
        GameObject faceLeft = GameObject.Find("L");   
        GameObject faceRight = GameObject.Find("R");  

        // es werden die Seiten bestimmt in welche Richtungen sie drehen sollen
        
        if (side == cubeState.up || side == cubeState.down)        
        {                        
            if(Mathf.Abs(faceUp.transform.position.y - 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.x + 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.z - 1f) < 0.1f)
            {
                rotation.y = (mouseOffset.x + mouseOffset.y) * sensitivity * -1;  
            }
            else if(Mathf.Abs(faceUp.transform.position.x + 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.y + 1f) < 0.1f && (faceLeft.transform.position.z -1f) < 0.1f)
            {
                rotation.x = (mouseOffset.x + mouseOffset.y) * sensitivity * -1;  
            }
            else if(Mathf.Abs(faceUp.transform.position.z + 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.y + 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.x + 1f) < 0.1f) 
            {
                rotation.x = (mouseOffset.x + mouseOffset.y) * sensitivity * -1;   
            } 
            else if(Mathf.Abs(faceUp.transform.position.z + 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.x + 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.y - 1f) < 0.1f)
            {
            ...
            else if(Mathf.Abs(faceUp.transform.position.x - 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.y - 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.z - 1f) < 0.1f)
            {
                rotation.x = (mouseOffset.x + mouseOffset.y) * sensitivity * 1;   
            }
            else if(Mathf.Abs(faceUp.transform.position.y + 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.x - 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.z - 1f) < 0.1f)
            {
                rotation.y = (mouseOffset.x + mouseOffset.y) * sensitivity * 1;   
            }
            else if(Mathf.Abs(faceUp.transform.position.z + 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.y - 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.x - 1f) < 0.1f)
            ...
            else if(Mathf.Abs(faceUp.transform.position.x - 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.z - 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.y + 1f) < 0.1f)
            {
                rotation.z = (mouseOffset.x + mouseOffset.y) * sensitivity * 1;   
            }
            else if(Mathf.Abs(faceUp.transform.position.x + 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.z + 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.y + 1f) < 0.1f)
            ...
            else if(Mathf.Abs(faceUp.transform.position.y - 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.z + 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.x + 1f) < 0.1f)
            {
                rotation.y = (mouseOffset.x + mouseOffset.y) * sensitivity * -1;   
            }
            else if(Mathf.Abs(faceUp.transform.position.y - 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.x - 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.z + 1f) < 0.1f)
        ...
        if (side == cubeState.left || side == cubeState.right)
        {
            if(Mathf.Abs(faceUp.transform.position.y - 1f) < 0.1f && Mathf.Abs(faceFront.transform.position.x + 1f) < 0.1f && Mathf.Abs(faceLeft.transform.position.z - 1f) < 0.1f)
            {
                rotation.z = (mouseOffset.x + mouseOffset.y) * sensitivity * -1;                 
