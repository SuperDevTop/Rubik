    ...
    */
    void Swipe()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if(!(firstPressPos.x < 970f && firstPressPos.x > 615f && firstPressPos.y > 210f && firstPressPos.y < 575f))
            {
                isPressed = true;
            }
            else
        ...
        if (Input.GetMouseButtonUp(0) && !(firstPressPos.x < 970f && firstPressPos.x > 615f && firstPressPos.y > 210f && firstPressPos.y < 575f))
        {
